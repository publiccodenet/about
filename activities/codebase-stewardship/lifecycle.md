...
In order to decide on if and how we can perform incubating stewardship [we assess](../codebase-stewardship-assesment/index.md) the codebase and its community together with the community. If it is an [existing codebase](for-existing-projects.md) we look at the [stewardship feasibility](../codebase-stewardship-assesment/criteria-for-codebase-stewardship.md) first.
