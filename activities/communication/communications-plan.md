...
* current and future contributors to Foundation for Public Code projects or activities (in the open source sense)
* influencers

### Foundation contributors

We believe these are [potential Foundation for Public Code contributors](../value-and-impact/user-mapping.md/).
...
* offers codebase stewardship for different projects (unlike open source software foundations that don't have a public sector focus)
...
We will also actively build our ecosystem by:
...
* nurturing our community online, at conferences and events

## Calls to action

All of our communications should end with a call to action - an invitation for the reader to learn more and potentially join us and our work.

Here are common calls to action batched by potential contributor type.

You can also [read more about how to open a pitch for the Foundation](pitching.md) for different audiences.
...
Our communications channels are:
...
The bulk of our social media engagement should take place Monday to Thursday. We aim to publish blogposts and jobs on Mondays (for maximum engagement).
